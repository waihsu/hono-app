...
export default function NextMatches() {
  const { matches, leagues, teams, publishMatches, ws } = useAdminStore();
  ...
  return (
    <BackofficeLayout>
      ...
      <div className=" space-y-8">
        <div>
          <MatchDataTable columns={matchColumns} data={nextData} />
        </div>
      </div>
    </BackofficeLayout>
  );
